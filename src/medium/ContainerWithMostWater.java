...
public class ContainerWithMostWater {
	 ...
	 * 
	 * Given a1,a2,a3.....an as input array.
	 * Lets assume a10 and a20 are the max area situation. We need to prove that a10 can be reached by left pointer 
	 * and during the time left pointer stays at a10, a20 can be reached by right pointer. 
	 ...
	 * 
	 * Since we are always moving the pointer with the smaller value, i.e. if a10 > a21, we should move pointer at a21 to a20, as we hope.
	 *  Why a10 >a21? Because if a21>a10, then area of a10 and a20 must be less than area of a10 and a21. 
