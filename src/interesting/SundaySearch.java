/**  
 * @Title: SundaySearch.java
 * @Prject: leetcode
 * @Package: interesting
 * @Description: TODO
 * @author: Evapandora  
 * @date: 2016年4月27日 上午9:56:12
 */
package interesting;

/**
 * @ClassName: SundaySearch
 * @Description: TODO
 * @author: Evapandora
 * @date: 2016年4月27日 上午9:56:12
 */
...
public class SundaySearch {
	...
	public SundaySearch(String text, String pattern) {
		this.text = text;
	...
	public static void main(String[] args) {
		SundaySearch sundySearch = new SundaySearch(
				"hello 啊啊 阿道夫 adfsadfklf adf234masdfsdfdsfdsfdsffwerwrewrerwerwersdf2666sdflsdfk", "adf");

		long begin = System.nanoTime();
		long beginT = System.currentTimeMillis();
		System.out.println("NormalMatch:" + sundySearch.normalMatch());
		System.out.println("NormalMatch:" + (System.nanoTime() - begin));
		System.out.println("NormalMatch:" + (System.currentTimeMillis() - beginT));
