...
public class Count1 {
	...
	private static int numberOf1(int[] numbers, int curIdx) {
		...
		int numFirstDigit = 0;
		// 如果最高位不是1，如21345，在[1236, 21345]中，最高位1出现的只在[10000,
		// 19999]中，出现1的次数是10^4方个
		if (first > 1) {
		...
		// numOtherDigits，是[1346, 21345]中，除了第一位之外（不看21345中的第一位2 ; 首位 出现 0 或者 1）的数位中的1的数目
