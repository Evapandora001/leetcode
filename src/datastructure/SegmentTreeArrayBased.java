/**  
 * @Title: SegementTree.java
 * @Prject: leetcode
 * @Package: datastructure
 * @Description: TODO
 * @author: Evapandora  
 * @date: 2016年5月3日 上午10:53:56
 */
package datastructure;

/**
 * @ClassName: SegementTree
 * @Description: 线段树  数组存储
 * @author: Evapandora
 * @date: 2016年5月3日 上午10:53:56
 */
public class SegmentTreeArrayBased {
	...
	public SegmentTreeArrayBased(int size) {
	...
	public static void main(String[] arg) {
		...
		SegmentTreeArrayBased segmentTree = new SegmentTreeArrayBased(6);
